...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--image_dir',
      type=str,
      default='D:\\Nicolas\\nuevoTraining\\Prostata\\Prostata-fases-base',
      help='Path to folders of labeled images.'
  )
  parser.add_argument(
      '--output_graph',
      type=str,
      default='/tmp/ModelosFase/base/base-E.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default='/tmp/ModelosFase/intermediate_graph/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='/tmp/ModelosFase/base/base-E.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='/tmp/ModelosFase/retrain_logs',
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default='/tmp/ModelosFase/imagenet',
      help="""\
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='/tmp/ModelosFase/bottleneck',
